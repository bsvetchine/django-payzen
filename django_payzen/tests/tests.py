...
class BasicPaymentTest(PaymentTester, TestCase):
...
class CustomizedPaymentTest(PaymentTester, TestCase):
...
class CustomizedThemeTest(PaymentTester, TestCase):
...
class MultiPaymentConfigTest(PaymentTester, TestCase):
